...
<form class="card" method="post" action="{:url('admin/setting/index')}">
	...
	<div class="card-body">
        ...
        <div class="form-group">
            <label>网站关键词</label>
            <input type="text" class="form-control" name="setting[keywords]" value="{$_G['setting']['keywords']}">
            <small class="form-text text-muted">SEO-网站关键词</small>
        </div>

        <div class="form-group">
            <label>网站描述词</label>
            <input type="text" class="form-control" name="setting[description]" value="{$_G['setting']['description']}">
		...
		<div class="form-group" style="width:30%;">
            ...
            <textarea class="form-control" id="editor_mobile" name="setting[mobile_cont]">{$_G['setting']['mobile_cont']}</textarea>
			<small class="form-text text-muted">网站页脚内容,支持自定义HTML</small>
		</div>
		<div class="form-group">
