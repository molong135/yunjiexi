<form class="card" method="post" autocomplete="off" action="{:url('admin/site/edit')}">
    ...
    <div class="card-body">
        ...
        <div class="form-group">
            <label>示例地址</label>
            <input type="text" name="download_url" class="form-control" value="{$site['download_url']??''}">
        ...
        <div class="form-group">
            <label>网页版状态</label>
            <div class="custom-control custom-radio">
                <input type="radio" class="custom-control-input" name="if_rjnode" value="1"  {if empty($site) || $site['if_rjnode'] == 1}checked{/if}>
                <label class="custom-control-label">启用</label>
            </div>
            <div class="custom-control custom-radio">
                <input type="radio" class="custom-control-input" name="if_rjnode" value="0"  {if !empty($site) && $site['if_rjnode'] == 0}checked{/if}>
                <label class="custom-control-label">关闭</label>
            </div>
