<div class="card">
    <div class="card-header d-flex justify-content-between">
        <div class="">
            ...
            <a class="btn btn-success btn-sm" href="{:url('admin/user/export')}" target="_blank">导出会员</a>

                <form class="btn btn-success btn-sm" method="get" autocomplete="off" action="{:url('admin/user/dousert')}">   
                    <input type="text" name="username" class="form-control" value="{$search}">
