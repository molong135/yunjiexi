...
<nav class="navbar navbar-expand-lg navbar-index bg-info">
	<div class="container">
	<a class="navbar-brand" href="{$_G['site_url']}"><img src="static/images/123-1.png" style="height: 56px;width: 147px;"></a>
	<div class="collapse navbar-collapse">
		<ul class="navbar-nav mr-auto">
			...
			</li><li class="nav-item {if $Request.controller == 'Index' && $Request.action == 'demo'}active{/if}">
				<a class="nav-link" href="{:url('index/index/chenpian')}" target="_blank">操作演示</a>
			</li><li class="nav-item {if $Request.controller == 'Index' && $Request.action == 'demo'}active{/if}">
		...
		<div class="navbar-nav">
			...
			{if $_G['uid']}
				...
				<li class="nav-item"><a class="nav-link" href="{:url('index/user/index')}">个人中心</a></li>
