<?php /*a:2:{s:73:"/www/wwwroot/shucaiwang/wp.shzmzxw/application/admin/view/log_dousert.php";i:1564641954;s:68:"/www/wwwroot/shucaiwang/wp.shzmzxw/application/admin/view/layout.php";i:1556520742;}*/ ?>
<!DOCTYPE html>
...
<div class="admin-content">
    ...
    <div class="card-header d-flex justify-content-between">
        会员解析记录
        <form class="btn btn-success btn-sm" method="get" autocomplete="off" action="<?php echo url('admin/log/dousert'); ?>">   
                    <input type="text" name="uid"  value="<?php echo htmlentities($search); ?>">
                    <button type="button" class="btn btn-success btn-submit btn-sm">查询解析记录</button>
                </form>
