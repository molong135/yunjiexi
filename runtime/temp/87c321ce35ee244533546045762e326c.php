<?php /*a:2:{s:66:"D:\WWW\sc\yc_sc\wp.shzmzxw\application\admin\view\user_dousert.php";i:1563695326;s:60:"D:\WWW\sc\yc_sc\wp.shzmzxw\application\admin\view\layout.php";i:1556520742;}*/ ?>
<!DOCTYPE html>
    ...
    <div class="card-header d-flex justify-content-between">
        <div class="">
            ...
            <a class="btn btn-success btn-sm" href="<?php echo url('admin/user/export'); ?>" target="_blank">导出会员</a>
                ...
                <form class="btn btn-success btn-sm" method="post" autocomplete="off" action="<?php echo url('admin/user/dousert'); ?>">   
