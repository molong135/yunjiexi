<?php /*a:5:{s:74:"F:\php\81sc\update\6-15\qtsc.shzmzxw\application\index\view\user_index.php";i:1556708024;s:70:"F:\php\81sc\update\6-15\qtsc.shzmzxw\application\index\view\layout.php";i:1560595839;s:77:"F:\php\81sc\update\6-15\qtsc.shzmzxw\application\index\view\public_header.php";i:1559142578;s:73:"F:\php\81sc\update\6-15\qtsc.shzmzxw\application\index\view\user_left.php";i:1555074814;s:77:"F:\php\81sc\update\6-15\qtsc.shzmzxw\application\index\view\public_footer.php";i:1560594325;}*/ ?>
<!DOCTYPE html>
				...
				<table class="table table-striped table-hover mb-0">
					...
					<tbody>
						<?php $i=0; foreach($_G['member']['site_access'] as $site_id => $access): 
							 ...
							 ?>
							<tr>
								<td class="<?php if(!$i): ?>border-top-0<?php endif; ?> text-success Clipboard" align="right" data-toggle="tooltip" data-placement="top" title="点击复制网址" data-clipboard-text="<?php echo htmlentities($_G['web_site'][$site_id]['url']); ?>"><?php echo htmlentities($_G['web_site'][$site_id]['title']); ?> ： </td>
								<td <?php if(!$i): ?>class="border-top-0"<?php endif; ?>>
