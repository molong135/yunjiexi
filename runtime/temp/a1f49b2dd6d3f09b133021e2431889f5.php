<?php /*a:2:{s:71:"/www/wwwroot/shucaiwang/wp.shzmzxw/application/admin/view/site_edit.php";i:1572412875;s:68:"/www/wwwroot/shucaiwang/wp.shzmzxw/application/admin/view/layout.php";i:1556520742;}*/ ?>
<!DOCTYPE html>
...
<div class="admin-content">
    ...
    <div class="card-body">
        ...
        <div class="form-group">
            <label>示例地址</label>
            <input type="text" name="download_url" class="form-control" value="<?php echo isset($site['download_url']) ? htmlentities($site['download_url']) : ''; ?>">
            <small class="form-text text-muted">示例地址（解析式需要输入相应格式的地址才能解析，例如：百度文库地址最后加.html和不加都能访问，但本站需要添加.html才能解析）</small>
        </div>
        <div class="form-group">
            <label>状态</label>
        ...
        <div class="form-group">
            <label>网页版状态</label>
            <div class="custom-control custom-radio">
                <input type="radio" class="custom-control-input" name="if_rjnode" value="1"  <?php if(empty($site) || $site['if_rjnode'] == 1): ?>checked<?php endif; ?>>
                <label class="custom-control-label">启用</label>
            </div>
            <div class="custom-control custom-radio">
                <input type="radio" class="custom-control-input" name="if_rjnode" value="0"  <?php if(!empty($site) && $site['if_rjnode'] == 0): ?>checked<?php endif; ?>>
                <label class="custom-control-label">关闭</label>
            </div>
            <small class="form-text text-muted">关闭后前台不显示该网页版支持并且不可解析</small>
        </div>
    </div>
