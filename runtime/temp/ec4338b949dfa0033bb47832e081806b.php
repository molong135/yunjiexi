<?php /*a:2:{s:74:"/www/wwwroot/shucaiwang/wp.shzmzxw/application/admin/view/user_dousert.php";i:1564641844;s:68:"/www/wwwroot/shucaiwang/wp.shzmzxw/application/admin/view/layout.php";i:1556520742;}*/ ?>
<!DOCTYPE html>
    ...
    <div class="card-header d-flex justify-content-between">
        <div class="">
            ...
            <a class="btn btn-success btn-sm" href="<?php echo url('admin/user/export'); ?>" target="_blank">导出会员</a>
                ...
                <form class="btn btn-success btn-sm" method="get" autocomplete="off" action="<?php echo url('admin/user/dousert'); ?>">   
                    <input type="text" name="username" class="form-control" value="<?php echo htmlentities($search); ?>">
                    <button type="button" class="btn btn-success btn-submit btn-sm">提交数据</button>
                </form>
