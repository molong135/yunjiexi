<?php /*a:2:{s:76:"/www/wwwroot/shucaiwang/wp.shzmzxw/application/admin/view/user_batch_add.php";i:1571658394;s:68:"/www/wwwroot/shucaiwang/wp.shzmzxw/application/admin/view/layout.php";i:1556520742;}*/ ?>
<!DOCTYPE html>
...
<div class="admin-content">
	<div class="p-3"><form class="card" method="post" autocomplete="off" action="<?php echo url('admin/user/batch_add'); ?>">
        ...
        <?php foreach($site_list as $site): ?>
            ...
            <div class="form-group d-flex justify-content-between">
                ...
                <div class="input-group mr-3">
                    ...
                    <input type="number" class="form-control" name="site_access[<?php echo htmlentities($site['site_id']); ?>][day]" placeholder="日解析最大次数" value="-1">
                </div>
                <div class="input-group">
                    <div class="input-group-prepend">
                        <div class="input-group-text">最大解析总次数</div>
                    </div>
                    <input type="number" class="form-control" name="site_access[<?php echo htmlentities($site['site_id']); ?>][all]" placeholder="最大解析总次数" value="0">
                </div>
            </div>
        <?php endforeach; ?>
    </div>
