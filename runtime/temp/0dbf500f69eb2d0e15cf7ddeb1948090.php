<?php /*a:2:{s:78:"/www/wwwroot/shucaiwang/wp.shzmzxw/application/admin/view/site_edit_cookie.php";i:1572166406;s:68:"/www/wwwroot/shucaiwang/wp.shzmzxw/application/admin/view/layout.php";i:1556520742;}*/ ?>
<!DOCTYPE html>
...
<div class="admin-content">
    ...
    <div class="card-body">
        ...
        <div class="form-group">
            <label>登录ip地址</label>
            <input type="text" name="dl_ip" class="form-control" value="<?php echo isset($cookie['dl_ip']) ? htmlentities($cookie['dl_ip']) : ''; ?>">
            <small class="form-text text-muted">这个ip是cookie的登录ip可以ip138.com查看</small>
        </div>
        <div class="form-group">
            <label>此cookie的备注</label>
            <textarea placeholder="Cookie备注" class="form-control" name="bz_text"><?php echo isset($cookie['bz_text']) ? htmlentities($cookie['bz_text']) : ''; ?></textarea>
            <small class="form-text text-muted">这个cookie是什么时间生效什么时间结束好及时更新</small>
        </div>
        <div class="form-group">
            <label>cookie多状态json</label>
            <div class="custom-control custom-radio">
                <input type="radio" class="custom-control-input" name="json_status" value="1" <?php if(empty($cookie) || $cookie['json_status'] == 1): ?>checked<?php endif; ?>>
                <label class="custom-control-label">启用</label>
            </div>
             <div class="custom-control custom-radio">
                <input type="radio" class="custom-control-input" name="json_status" value="0" <?php if(!empty($cookie) && $cookie['json_status'] == 0): ?>checked<?php endif; ?>>
